...
#include "SizeProject/TP_WeaponComponent.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTP_WeaponComponent() {}
// Cross Module References
	SIZEPROJECT_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
	SIZEPROJECT_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(ASizeProjectCharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			ASizeProjectCharacter* TargetCharacter;
		};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_WeaponComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2319678139
	...
	template<> SIZEPROJECT_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_WeaponComponent);
	struct Z_CompiledInDeferFile_FID_SizeProject_Source_SizeProject_TP_WeaponComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SizeProject_Source_SizeProject_TP_WeaponComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 2105235962U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SizeProject_Source_SizeProject_TP_WeaponComponent_h_2341751238(TEXT("/Script/SizeProject"),
		Z_CompiledInDeferFile_FID_SizeProject_Source_SizeProject_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SizeProject_Source_SizeProject_TP_WeaponComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
